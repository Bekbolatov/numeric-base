...
.controller 'TasksMarketplaceCtrlOld', ['$scope', '$location', 'Settings', 'Tracker', 'Marketplace', 'ActivityManager', ($scope, $location, Settings, Tracker, Marketplace, ActivityManager ) ->
    if !Settings.ready
